...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['log'])) {
        ...
        $sql = "Select * from seller where seller_name = '$user' and email ='$email' ";
        ...
        if($result){
            ...
            if($num > 0){
                ...
                $sql_insert = "INSERT INTO seller (seller_name,	email,wallet_address)VALUES ('$user','$email','$password')";
