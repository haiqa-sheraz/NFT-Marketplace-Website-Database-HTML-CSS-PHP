    ...
    <body>
        ...
        <nav class="navbar">
            <div class="navbar__container">
                ...
                <ul class="navbar__menu">
                    ...
                    <li class="navbar__item">
                        <a href="explore.html" class="navbar__links">Explore</a>
                    </li>
                    <li class="navbar__item">
                        <a href="bs.html" class="navbar__links">Sell</a>
                    </li>
        ...
        <div class="login-form">
            ...
            <form action="#" method="post">
                ...
                <p class="signup">Not on LooksRare yet? <a href="bs.html"> <u>Sign up</u></a></p>
            </form>
        </div>
        <!-- Footer section -->
