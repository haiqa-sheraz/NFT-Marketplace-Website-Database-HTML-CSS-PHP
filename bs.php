    ...
    <body>
        ...
        <div class="signup-form">
            ...
            <form action="#" method="post">
                <button class="signup__btn" type="button" onclick="location.href='signin_buyer.php'">Buyer</button>
                <p>or</p>
                <button class="signup__btn" type="button" onclick="location.href='signin_seller.php'">Seller</button>
            </form>
        </div>
        <!-- Footer section -->
